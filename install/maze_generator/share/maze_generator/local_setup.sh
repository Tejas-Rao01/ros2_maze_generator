...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/ros2_maze_generator/install/maze_generator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/maze_generator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/maze_generator/environment/path.sh"
